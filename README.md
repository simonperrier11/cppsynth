...
- Real time adjustable OSC2 pitch by +/- 24 semitones and +/- 50 cents
- **Polyphonic** mode, up to 10 voices simultaneously, and **monophonic** mode with last note priority
...
- Make sure to move the VST3 file to a folder that your DAW will recognize!
